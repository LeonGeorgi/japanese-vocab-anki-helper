...
import { useExampleTranslation } from '../../hooks/useExampleTranslation'
import { useImageTranscription } from './useImageTranscription'
import { useKanjiConversion } from '../../hooks/useKanjiConversion'
import { useWordExtraction } from './useWordExtraction'
import { useWordSplitting } from '../../hooks/useWordSplitting'
import { emptyLoadingExample, exampleWithError, exampleWithSentence, renameRecordKey } from '../../hooks/vocabStateHelpers'
